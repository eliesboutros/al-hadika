...
- **Deployment:** VPS or any Rails-compatible host
...
└── views/
    ├── pages/
    │   └── contact.html.slim         # Contact form page
    └── contact_mailer/
...
`letter_opener` is included in the Gemfile for development:
```ruby
...
For full backend and server setup documentation, see [readme/devops.md](readme/devops.md).

### VPS/Server Deployment

1. Set up Ruby 4.0.2 and Rails 8.1.3 environment
2. Clone repository
3. Set environment variables
4. Configure Nginx + Puma
